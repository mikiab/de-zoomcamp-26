The homework solutions utilize this [GCP scheduled YAML file](./flows/zoomcamp.gcp_taxi_scheduled.yaml).

All queries were run in Google BigQuery.
...
2. What is the rendered value of the variable file when the inputs taxi is set
   to green, year is set to 2020, and month is set to 04 during execution?

Answer: `green_tripdata_2020-04.csv`

3. How many rows are there for the Yellow Taxi data for all CSV files in the
   year 2020? 
...
4. How many rows are there for the Green Taxi data for all CSV files in the year
2020?
...
5. How many rows are there for the Yellow Taxi data for the March 2021 CSV
   file?
